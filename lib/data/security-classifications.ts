...
/**
 * GICS-like sector mapping for stocks (coarser than fund_category).
 * Used when we want simple sector allocation without the fund_category detail.
 */
export const SECTOR_MAP: Record<string, string> = {
  // Technology
  AAPL: "Technology", MSFT: "Technology", GOOG: "Technology", GOOGL: "Technology",
  CRM: "Technology", ORCL: "Technology", INTU: "Technology", ACN: "Technology",
  NVDA: "Semiconductors", AVGO: "Semiconductors", AMD: "Semiconductors",
  INTC: "Semiconductors", MU: "Semiconductors", QCOM: "Semiconductors",
  TER: "Semiconductors", TSM: "Semiconductors", ASML: "Semiconductors",
  RMBS: "Semiconductors", AMKR: "Semiconductors",
  NET: "Technology", DDOG: "Technology", SNOW: "Technology", PLTR: "Technology",
  SHOP: "Technology", TTD: "Technology", DBX: "Technology", GTLB: "Technology",
  U: "Technology", WIX: "Technology", PSTG: "Technology", APP: "Technology",
  RBLX: "Technology", SPOT: "Communication Services", SNAP: "Communication Services",
  PINS: "Communication Services", RDDT: "Communication Services", NFLX: "Communication Services",
  META: "Technology", DIS: "Communication Services",

  // Financial
  JPM: "Financial", GS: "Financial", BAC: "Financial", V: "Financial",
  MA: "Financial", "BRK/B": "Financial", COIN: "Financial",
  HOOD: "Financial", AFRM: "Financial", JEF: "Financial", RKT: "Financial",

  // Health Care
  UNH: "Health Care", VRTX: "Health Care", DHR: "Health Care",
  HIMS: "Health Care", TDOC: "Health Care", OSCR: "Health Care", OCUL: "Health Care",

  // Consumer
  AMZN: "Consumer Discretionary", TSLA: "Consumer Discretionary",
  HD: "Consumer Discretionary", NKE: "Consumer Discretionary",
  ABNB: "Consumer Discretionary", CVNA: "Consumer Discretionary",
  DKNG: "Consumer Discretionary", RH: "Consumer Discretionary",
  KO: "Consumer Staples", TGT: "Consumer Staples", KR: "Consumer Staples",

  // Industrials
  NSC: "Industrials", CSX: "Industrials", VRT: "Industrials",
  PWR: "Industrials", PRIM: "Industrials", XPO: "Industrials",
  CPRT: "Industrials", GFL: "Industrials", CLH: "Industrials",
  UBER: "Technology",

  // Energy
  XOM: "Energy", VLO: "Energy", ET: "Energy",
  CEG: "Utilities", VST: "Utilities", OKLO: "Utilities",

  // Real Estate
  PLD: "Real Estate", VNQ: "Real Estate", HPP: "Real Estate",
  CPT: "Real Estate", KRC: "Real Estate", CLPR: "Real Estate",
  LAND: "Real Estate", HHH: "Real Estate",

  // Materials
  LIN: "Materials", MP: "Materials", HUN: "Materials",

  // China/International
  BABA: "China", BIDU: "China", PDD: "China", TCEHY: "China",
  KWEB: "China", MELI: "Latin America", GRAB: "Southeast Asia",
};
