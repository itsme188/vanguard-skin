 ...
 * analysis-diagnostics--two-herfindahl-values-same-page-regression-3 — a
 * pre-rounded `effective_positions` of 58.5 fed back through Math.round
 * became 59, while the raw 58.48 correctly rounds to 58).
 */
