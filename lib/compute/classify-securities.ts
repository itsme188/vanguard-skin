...
fund_category: for US single-name stocks and US sector funds use the scheme "US Sector Equity (<Sector>)" — e.g. "US Sector Equity (Technology)", "US Sector Equity (Semiconductors)", "US Sector Equity (Health Care)", "US Sector Equity (Financials)". Never emit a bare sector name like "Technology". Other valid examples: "US Large Cap Equity", "US Small Cap Equity", "International Equity", "Diversified Bond", "US Treasury".
