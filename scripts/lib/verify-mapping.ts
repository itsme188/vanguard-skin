...
export const MAPPING: MappingEntry[] = [
  ...
  {
    category: "db",
    match: ["lib/queries/", "lib/mutations/", "lib/db/", "lib/db.ts"],
  ...
  {
    category: "research",
    match: ["lib/research/", "lib/research-inbox/", "lib/research-documents/"],
    testTargets: ["tests/research/", "tests/research-inbox/", "tests/research-documents/"],
    reminders: [],
  },
  {
    category: "trade-review",
    match: ["lib/trade-review/"],
    testTargets: ["tests/trade-review/"],
    reminders: [],
  },
  {
    category: "cron",
    match: ["lib/cron/"],
    testTargets: ["tests/cron/"],
    reminders: [],
  },
  {
    category: "benchmark",
    match: ["lib/benchmark/"],
    testTargets: ["tests/benchmark/"],
    reminders: [],
  },
  {
    category: "etf",
    match: ["lib/etf/"],
    testTargets: ["tests/etf/"],
    reminders: [],
  },
  {
    category: "plaid",
    match: ["lib/plaid/"],
    testTargets: ["tests/plaid/"],
    reminders: [],
  },
  {
    category: "quotes",
    match: ["lib/quotes/"],
    testTargets: ["tests/quotes/"],
    reminders: [],
  },
  {
    category: "securities",
    match: ["lib/securities/"],
    testTargets: ["tests/securities/"],
    reminders: [],
  },
  {
    category: "http",
    match: ["lib/http/"],
    testTargets: ["tests/http/"],
    reminders: [],
  },
  {
    category: "apis",
    match: ["lib/apis/"],
    testTargets: ["tests/apis/"],
    reminders: [],
  },
  {
    category: "worker",
