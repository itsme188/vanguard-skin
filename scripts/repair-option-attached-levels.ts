 ...
 * no option filter. So a held contract such as "FOXA  270618C00030000" was
 * offered to the model as a tracked symbol, and an author saying "trimmed at
 * $52" produced an exit level on the CALL. There it is compared against the
 * option PREMIUM (it can only fire if the premium reaches $52) and the
